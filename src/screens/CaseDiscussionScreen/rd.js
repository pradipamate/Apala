...
import { View, ScrollView, TouchableOpacity, AsyncStorage, FlatList, Modal, Image, Switch, StyleSheet, Text, Alert } from 'react-native';
              ...
              <CardItem>
                <View style={{ width: '90%', flexDirection: 'row' }}>
                  {profilePhoto !== null ?
                    ...
                    : <View style={{ height: 50, width: 50, borderRadius: 25 }}></View>}
                  <Input
                    //containerStyle={{ height: 30, marginTop: 0,backgroundColor:'red'}}
                    placeholder='Add a comment'
                    ...
                    inputContainerStyle={{ borderWidth: 1, paddingLeft: '2%', borderRadius: 10, borderColor: '#03B38F',height:40}}
                    leftIconContainerStyle={{ marginLeft: 2 }}
                   // value={comment}
                    onChangeText={text => setcomment(text)}
                  // errorMessage={this.state.userNameErrMsg}
